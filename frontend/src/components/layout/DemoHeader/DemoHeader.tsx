    ...
    <header className="w-full bg-casper-blue">
      <div className="flex flex-row justify-between relative w-full max-w-1600 pl-22 md:pl-30 xl:pl-46 pr-28 md:pr-36 xl:pr-52">
        ...
        <form onSubmit={handleSubmit(submitPath)}>
          ...
          <div className="bg-casper-blue flex relative justify-center pt-33">
            <select
            ...
            <input
              ...
              type="search"
              id="search"
              className="block py-4 sm:py-6 md:py-10 px-20 sm:pl-20 md:px-20 text-xs text-gray-900 bg-gray-50 rounded-lg border-1 border-solid border-gray-400 focus:outline-none w-full max-w-280 xl:w-500 xxs:text-sm xxs:pr-32"
              required
            />
            <button
              type="submit"
