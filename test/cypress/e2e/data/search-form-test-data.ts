export const searchFormTestData = () => {
  ...
  const blockHeight: string = '1774040';

  const hashContainingSpaces: string =
    'a 3e 3221106479c257c8c5e6cde1e279bb9e28e70c38ca2593cb3a7806e2090a';
  const hashContainingNonHexadecimalCharacters: string =
    '%&18f84c6fc037284f189cc8cb49f89212ff434a5eb050e48cdd164ff3890fbff69';
  const hashContainingTooManyCharacters: string =
